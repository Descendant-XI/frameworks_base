 ...
 */
public class SquaryClockExtendedController implements ClockPlugin {
     ...
     */
    public SquaryClockExtendedController(Resources res, LayoutInflater inflater,
    ...
    private void createViews() {
        mView = (ClockLayout) mLayoutInflater
                .inflate(R.layout.digital_clock_custom_squaryclock_extended, null);
        mClock = mView.findViewById(R.id.clock);
        mDate = mView.findViewById(R.id.date);
        mWholeBkg = mView.findViewById(R.id.background);
        mWeatherIcon = mView.findViewById(R.id.weather_icon);
        mWeatherDegrees = mView.findViewById(R.id.weather_degrees);
        setData();
    }

    private void setData() {
        String date = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date());
        mClock.setFormat12Hour(Html.fromHtml("hh:mm"));
        mClock.setFormat24Hour(Html.fromHtml("kk:mm"));
        mDate.setText(date);
        //mWeatherIcon.setImageResource();
        mWeatherDegrees.setText("10");
    }
    ...
    public String getName() {
        return "squary_clock_extended";
    }

    @Override
    public String getTitle() {
        return mResources.getString(R.string.clock_title_squary_clock_extended);
    }
    ...
    public void setTextColor(int color) {
        ...
        switch (mResources.getConfiguration().uiMode & Configuration.UI_MODE_NIGHT_MASK) {
            case Configuration.UI_MODE_NIGHT_YES:
                mWholeBkg.setImageResource(R.drawable.squary_clock_extended_dark);
                mClock.setTextColor(Color.WHITE);
                break;
            case Configuration.UI_MODE_NIGHT_NO:
                mWholeBkg.setImageResource(R.drawable.squary_clock_extended_light);
